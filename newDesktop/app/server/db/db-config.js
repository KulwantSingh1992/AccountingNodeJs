...
//Create PaymentSheet specific tables
   ...
   db.run('CREATE TABLE IF NOT EXISTS gl_account_organization_and_class (gl_account_id INTEGER,organization_party_id TEXT,role_type_id TEXT,gl_account_type_id TEXT,gl_account_class_id TEXT,account_name TEXT)');
}
