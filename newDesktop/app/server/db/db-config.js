...
db.run('CREATE TABLE IF NOT EXISTS acctg_trans (acctg_trans_id TEXT, acctg_trans_type_id TEXT, description TEXT, transaction_date TEXT, is_posted TEXT,  voucher_ref TEXT, voucher_date TEXT, order_id TEXT, inventory_item_id TEXT, party_id TEXT, extra TEXT DEFAULT "{}",PRIMARY KEY(acctg_trans_id,order_id))');
